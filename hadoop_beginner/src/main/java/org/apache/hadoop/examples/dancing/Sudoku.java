...
public class Sudoku
{
	...
	/**
	 * The preset values in the board board[y][x] is the value at x,y with -1 =
	 * any
	 */
	private int[][] board;
	...
	/**
	 * This interface is a marker class for the columns created for the Sudoku
	 * solver.
	 */
	 ...
	 *            the size of the board
	 * @param solution
	 *            a list of list of column names
	 ...
	 * 
	 * @param rowValues
	 *            a scratch pad to mark the bits needed
	 * @param x
	 *            the horizontal offset of the cell
	 * @param y
