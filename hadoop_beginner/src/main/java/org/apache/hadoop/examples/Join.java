 ...
 * bin/hadoop jar build/hadoop-examples.jar join [-m <i>maps</i>] [-r
 ...
 * value class</i>] [-joinOp &lt;inner|outer|override&gt;] [<i>in-dir</i>]*
...
public class Join extends Configured implements Tool
{
	...
	{
		System.out.println("join [-m <maps>] [-r <reduces>] " + "[-inFormat <input format class>] " + "[-outFormat <output format class>] "
			+ "[-outKey <output key class>] " + "[-outValue <output value class>] " + "[-joinOp <inner|outer|override>] " + "[input]* <input> <output>");
