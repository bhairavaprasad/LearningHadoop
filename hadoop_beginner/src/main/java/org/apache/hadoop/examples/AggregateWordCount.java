 ...
 * a locally sorted list of words and the count of how often they occurred. To
 * run: bin/hadoop jar hadoop-examples-*.jar aggregatewordcount <i>in-dir</i>
...
public class AggregateWordCount
{
	...
	public static void main(String[] args)
		throws IOException
	{
		JobConf conf = ValueAggregatorJob.createValueAggregatorJob(args, new Class[] { WordCountPlugInClass.class }, AggregateWordCount.class);
