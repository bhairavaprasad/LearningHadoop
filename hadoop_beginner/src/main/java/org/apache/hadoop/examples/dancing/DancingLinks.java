 ...
 * subset of the rows such that each column has exactly 1 true in it. The
 * application gives each column a name and each row is named after the set of
 * columns that it has as true. Solutions are passed back by giving the selected
 * rows' names. The type parameter ColumnName is the class of application's
 * column names.
 */
public class DancingLinks<ColumnName>
{
	...
	private static class Node<ColumnName>
	{
		...
		Node(Node<ColumnName> l, Node<ColumnName> r, Node<ColumnName> u, Node<ColumnName> d, ColumnHeader<ColumnName> h)
		{
			left = l;
			right = r;
			up = u;
	 ...
	 * satisfy this column. The names are provided by the application and can be
	 * anything. The size is used for the heuristic for picking the next column
	 * to explore.
	 */
	 ...
	 *            solutions
	 * @param primary
	 *            Is the column required for a solution?
	 */
	 ...
	 * 
	 * @param name
	 *            The name of the column, which will be included in the solution
	 */
	 ...
	 * 
	 * @param partial
	 *            a temporary datastructure to keep the current partial answer
	 *            in
	 * @param output
	 *            the acceptor for the results that are found
	 ...
	 * 
	 * @param depth
	 *            the depth to explore down
	 * @param choices
	 *            an array of length depth to describe a prefix
	 * @param prefixes
	 *            a working datastructure
	 */
	 ...
	 * 
	 * @param goalRow
	 *            the row that should be choosen
