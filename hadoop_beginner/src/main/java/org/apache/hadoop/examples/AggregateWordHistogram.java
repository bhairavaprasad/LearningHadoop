 ...
 * histogram of the words in the input texts. To run: bin/hadoop jar
 * hadoop-examples-*.jar aggregatewordhist <i>in-dir</i> <i>out-dir</i>
 * <i>numOfReducers</i> textinputformat
 */
public class AggregateWordHistogram
{
	...
	public static void main(String[] args)
		throws IOException
	{
		JobConf conf = ValueAggregatorJob.createValueAggregatorJob(args, new Class[] { AggregateWordHistogramPlugin.class }, AggregateWordHistogram.class);
